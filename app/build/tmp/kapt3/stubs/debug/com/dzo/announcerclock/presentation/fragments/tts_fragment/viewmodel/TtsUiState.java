...
public final class TtsUiState {
    ...
    private final boolean enableDuringPhoneCalls = false;
    ...
    java.util.List<? extends android.speech.tts.Voice> voices, boolean timeSpeakingEnabled, boolean ttsReady, boolean enableDuringPhoneCalls, boolean disableWhilePlayingMusic) {
        super();
    }
    ...
    public final boolean getEnableDuringPhoneCalls() {
        return false;
    }
