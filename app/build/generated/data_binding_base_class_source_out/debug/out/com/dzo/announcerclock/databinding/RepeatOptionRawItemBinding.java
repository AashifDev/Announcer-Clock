...
public final class RepeatOptionRawItemBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static RepeatOptionRawItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RepeatOptionRawItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.repeat_option_raw_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RepeatOptionRawItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RepeatOptionRawItemBinding((ConstraintLayout) rootView, rawItemId, selectedItem,
          title);
    }
