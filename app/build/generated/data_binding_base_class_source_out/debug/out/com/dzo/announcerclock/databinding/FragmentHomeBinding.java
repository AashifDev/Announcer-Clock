...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull ScrollView rootView,
      ...
      @NonNull LinearLayout outlineHeader, @NonNull ProgressBar progressBar,
      ...
      @NonNull ConstraintLayout setRepeatTime, @NonNull LinearLayoutCompat setScheduling,
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((ScrollView) rootView, circularProgress, custom,
          ...
          newScheduling, outlineHeader, progressBar, repeat, scrollView, selectedRepeatTime,
          selectedSound, selectedVibration, selectedVolume, setRepeatTime, setScheduling, setSound,
          setTheme, setTtsSettings, setVibration, setVolume, settings, sound, speakCurrentTime,
          themeCard, timerText, tts, txtEnableScheduling, txtScheduleTimer, txtSetting, txtTheme,
          txtThemes, txtTts, vibration, volRocker, volume);
    }
