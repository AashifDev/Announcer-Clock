...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(4).put(LazyClassKeyProvider.com_dzo_announcerclock_presentation_fragments_repeat_option_viewmodel_RepeatOptionViewModel, RepeatOptionViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_dzo_announcerclock_presentation_fragments_sound_fragment_viewmodel_SoundOptionViewModel, SoundOptionViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_dzo_announcerclock_presentation_fragments_home_fragment_viewmodel_TimerViewModel, TimerViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_dzo_announcerclock_presentation_fragments_tts_fragment_viewmodel_TtsViewModel, TtsViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.soundOptionViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
      this.timerViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
      this.ttsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(4).put(LazyClassKeyProvider.com_dzo_announcerclock_presentation_fragments_repeat_option_viewmodel_RepeatOptionViewModel, ((Provider) repeatOptionViewModelProvider)).put(LazyClassKeyProvider.com_dzo_announcerclock_presentation_fragments_sound_fragment_viewmodel_SoundOptionViewModel, ((Provider) soundOptionViewModelProvider)).put(LazyClassKeyProvider.com_dzo_announcerclock_presentation_fragments_home_fragment_viewmodel_TimerViewModel, ((Provider) timerViewModelProvider)).put(LazyClassKeyProvider.com_dzo_announcerclock_presentation_fragments_tts_fragment_viewmodel_TtsViewModel, ((Provider) ttsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.dzo.announcerclock.presentation.fragments.sound_fragment.viewmodel.SoundOptionViewModel 
          ...
          case 2: // com.dzo.announcerclock.presentation.fragments.home_fragment.viewmodel.TimerViewModel 
          ...
          case 3: // com.dzo.announcerclock.presentation.fragments.tts_fragment.viewmodel.TtsViewModel 
