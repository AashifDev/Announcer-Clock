...
public abstract class Hilt_NotificationSoundFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotificationSoundFragment(
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotificationSoundFragment_GeneratedInjector) this.generatedComponent()).injectNotificationSoundFragment(UnsafeCasts.<NotificationSoundFragment>unsafeCast(this));
    }
  }
