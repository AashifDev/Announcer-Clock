...
public abstract class Hilt_RepeatOptionFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RepeatOptionFragment_GeneratedInjector) this.generatedComponent()).injectRepeatOptionFragment(UnsafeCasts.<RepeatOptionFragment>unsafeCast(this));
    }
  }
