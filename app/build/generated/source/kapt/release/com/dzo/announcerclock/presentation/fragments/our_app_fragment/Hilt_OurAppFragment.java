...
public abstract class Hilt_OurAppFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OurAppFragment_GeneratedInjector) this.generatedComponent()).injectOurAppFragment(UnsafeCasts.<OurAppFragment>unsafeCast(this));
    }
  }
