...
public abstract class Hilt_TextToSpeechFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TextToSpeechFragment_GeneratedInjector) this.generatedComponent()).injectTextToSpeechFragment(UnsafeCasts.<TextToSpeechFragment>unsafeCast(this));
    }
  }
