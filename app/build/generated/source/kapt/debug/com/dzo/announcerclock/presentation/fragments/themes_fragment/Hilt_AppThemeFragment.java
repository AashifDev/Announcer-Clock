...
public abstract class Hilt_AppThemeFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppThemeFragment_GeneratedInjector) this.generatedComponent()).injectAppThemeFragment(UnsafeCasts.<AppThemeFragment>unsafeCast(this));
    }
  }
